...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Reward'
        db.create_table(u'familyquest_reward', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='member', to=orm['familyquest.FamilyMember'])),
            ('duration_seconds', self.gf('django.db.models.fields.IntegerField')()),
            ('reward_type', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'familyquest', ['Reward'])


    def backwards(self, orm):
        # Deleting model 'Reward'
        db.delete_table(u'familyquest_reward')
    ...
    models = {
        ...
        u'familyquest.chore': {
            ...
            'achiever': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'achiever'", 'null': 'True', 'to': u"orm['familyquest.FamilyMember']"}),
        ...
        u'familyquest.reward': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'member'", 'to': u"orm['familyquest.FamilyMember']"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
