...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chore.achiever'
        db.alter_column(u'familyquest_chore', 'achiever_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['familyquest.FamilyMember']))

    def backwards(self, orm):

        # Changing field 'Chore.achiever'
        db.alter_column(u'familyquest_chore', 'achiever_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['familyquest.FamilyMember']))
    ...
    models = {
        ...
        u'familyquest.chore': {
            ...
            'achiever': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'achiever'", 'null': 'True', 'to': u"orm['familyquest.FamilyMember']"}),
